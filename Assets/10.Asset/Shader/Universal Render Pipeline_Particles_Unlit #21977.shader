...
SubProgram "d3d11 " {
Keywords { "PROCEDURAL_INSTANCING_ON" "STEREO_INSTANCING_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "FOG_LINEAR" }
...
SubProgram "d3d11 " {
Keywords { "FOG_LINEAR" "PROCEDURAL_INSTANCING_ON" "STEREO_INSTANCING_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "FOG_EXP" }
...
SubProgram "d3d11 " {
Keywords { "FOG_EXP" "PROCEDURAL_INSTANCING_ON" "STEREO_INSTANCING_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "FOG_EXP2" }
...
SubProgram "d3d11 " {
Keywords { "FOG_EXP2" "PROCEDURAL_INSTANCING_ON" "STEREO_INSTANCING_ON" }
"// shader disassembly not supported on DXBC"
}
}
Program "fp" {
